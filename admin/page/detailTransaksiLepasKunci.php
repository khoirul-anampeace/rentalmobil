...
?>
    ...
    <div class="row" id="detailCustomer">
        ...
        <div class="col-md-12 col-sm-6">
            <a href=".?page=transaksiBaruLepasKunci" style="width: 10rem;" class="btn btn-danger">Batalkan</a>
            <button class="btn btn-primary float-end" style="width: 10rem;" name="konfirmasi">Konfirmasi</button>
        </div>
