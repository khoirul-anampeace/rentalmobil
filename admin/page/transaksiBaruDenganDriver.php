...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">Transaksi Baru Dengan Driver</h4>
        </div>
    </div>
</div>
<!-- end page title -->
