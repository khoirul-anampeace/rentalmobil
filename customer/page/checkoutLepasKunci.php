                    ...
                    <div class="box">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="date" name="berangkat" class="form-control" id="berangkat" value="HAHA" autofocus required autocomplete="off">
                            </div>
                            <div class="col-md-6 mb-4">
                                <label for="kembali" class="form-label">Kembali</label>
                                <input type="date" name="kembali" class="form-control" id="kembali" required autocomplete="off">
                            </div>
