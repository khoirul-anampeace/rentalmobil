<section class="content customer" id="mainMobil">
    <div class="container" id="">
        ...
        <div class="row pilihmobil">
            <form method="GET" class="jenismobil">
            ...
            if (isset($_GET["jenis_sewa"]) || $_GET["jenis_sewa"] == "") {
                ...
                $no = 1;
                $jumlahDataMobil = mysqli_query($connect, "SELECT * FROM mobil m JOIN kondisi_mobil km ON m.id_mobil = km.id_mobil WHERE m.status_mobil = 'Tersedia'");
