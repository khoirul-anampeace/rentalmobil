<?php
session_start();
if (!empty($_SESSION['nik']) && !empty($_SESSION["nokk"]) && !empty($_SESSION["tempatlahir"]) && !empty($_SESSION["tgllahir"]) && !empty($_SESSION["alamatasli"]) && !empty($_SESSION["alamatdomisili"])) {

    $inputnik = $_SESSION['nik'];
    $inputnokk = $_SESSION["nokk"];
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <input type="number" value="<?= $inputnokk ?>" name="nokk" class="form-control" id="inputKK" placeholder="3*****" required autocomplete="off">
                </div>
                <div class="col-md-6 mb-4">
